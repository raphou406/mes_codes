...
void mousePressed() {
  ...
  if (mouseX>25*width/100 && mouseY>15*height/100 && mouseX<40*width/100 && mouseY<20*height/100 && decor.getMenuSettings() ) {
    decor.jour=false;
  }
  if (mouseX>50*width/100 && mouseY>15*height/100 && mouseX<65*width/100 && mouseY<20*height/100 && decor.getMenuSettings() ) {
    decor.jour=true;
  }
  if (mouseX>25*width/100 && mouseY>25*height/100 && mouseX<30*width/100 && mouseY<30*height/100 && decor.getMenuSettings() ) {
    bateau.couleur=color(255, 0, 0);
  }
  if (mouseX>33*width/100 && mouseY>25*height/100 && mouseX<38*width/100 && mouseY<30*height/100 && decor.getMenuSettings() ) {
    bateau.couleur=color(0, 255, 0);
  }
  if (mouseX>41*width/100 && mouseY>25*height/100 && mouseX<46*width/100 && mouseY<30*height/100 && decor.getMenuSettings() ) {
    bateau.couleur=color(255, 255, 0);
  }
  if (mouseX>25*width/100 && mouseY>35*height/100 && mouseX<40*width/100 && mouseY<40*height/100 && decor.getMenuSettings() ) {
    decor.deplacementSouris=true;
  }
  if (mouseX>50*width/100 && mouseY>35*height/100 && mouseX<65*width/100 && mouseY<40*height/100 && decor.getMenuSettings() ) {
    decor.deplacementSouris=false;
  }
