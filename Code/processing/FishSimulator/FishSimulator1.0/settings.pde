...
//permet de cliquer sur tout les bouttons des parametres
  ...
  if(mouseX>posBateauX+27 && mouseY<posBateauY-27 && mouseX<posBateauX+43 && mouseY>posBateauY-43){
    secret=true;
    vPoisson=2;
  }
}
